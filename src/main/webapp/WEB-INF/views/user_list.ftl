...
<table width="1500" height="600" border="0" cellpadding="0" cellspacing="0">
    ...
    <tr>
        ...
        <td width="500" height="200"><table width="500" height="200" border="1" cellpadding="0" cellspacing="0">
            <tr>
                ...
                <td width="160" height="65" align="center" valign="middle"><span class="STYLE15">tel</span></td>
                <td width="160" height="65" align="center" valign="middle"><span class="STYLE15">token</span></td>
            </tr>
        <#list userDo as user>
            ***${user}***${time}
            <tr>
                <td width="160" height="65" align="center" valign="middle"><span class="STYLE15">${user.id}</span></td>
                <td width="160" height="65" align="center" valign="middle"><span class="STYLE15">${user.tel}</span></td>
                <td width="160" height="65" align="center" valign="middle"><span class="STYLE15">${user.token}</span></td>
            </tr>
        </#list>
        </table></td>
        <td width="500" height="200">&nbsp;</td>
    ...
    <tr>
        <td width="500" height="200">&nbsp;aaa</td>
        <td width="500" height="200">&nbsp;bbb</td>
        <td width="500" height="200">&nbsp;ccc</td>
    </tr>
    <img src="/static/images/acmilan.jpg" />
</table>
</body>
</html>